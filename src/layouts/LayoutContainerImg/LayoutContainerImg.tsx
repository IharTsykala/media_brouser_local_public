...
const LayoutContainerImg: React.FunctionComponent<LayoutContainerImgProps> = ({ children, headerName, isEmpty }) => {
  ...
  return (
    <Card padding={4} className={outsideClass}>
      <Box className={"layout-gallery-img__inside"} padding={[3, 3, 4, 5]} style={{ width: "100%", margin: "0 auto" }}>
